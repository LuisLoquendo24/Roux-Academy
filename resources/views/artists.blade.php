...
<section id="main">
  ...
  <aside id="sidebar">
    <article>
      ...
      <div class="pixgrid">
        @include('includes.cuadros_artistas')
</div>
    </article>
    <!-- Featured Artists -->
    @include('includes.iphone')
    <!-- Coming to event -->
  </aside>
  <!-- Sidebar -->
