...
<section id="main">
    ...
    <article id="hotellist">
      <ul>
        ...
        <li> <img src="{{ asset('imagenes/hotel_otter.jpg') }}" alt="The Otter Renaissance Hotel">
          <div class="textgroup">
        ...
        <li> <img src="{{ asset('imagenes/hotel_rage.jpg') }}" alt="The Rage Hotel">
          <div class="textgroup">
        ...
        <li> <img src="{{ asset('imagenes/hotel_gwendoline.jpg') }}" alt="Hotel Gwendoline’s Fancy">
          <div class="textgroup">
