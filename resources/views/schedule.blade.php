...
<section id="main">
    ...
    <section id="monday" class="schedule">
      <div class="dayinfo">
        ...
        <div class="events">
          <ul>
            <li> <img src="{{ asset('imagenes/LaVonne_LaRue_tn.jpg') }}" alt="Art in Unexpected Places">
              <div class="textinfo">
            ...
            <li> <img src="{{ asset('imagenes/Constance_Smith_tn.jpg') }}" alt="Art in Unexpected Places">
              <div class="textinfo">
            ...
            <li> <img src="{{ asset('imagenes/Riley_Rewington_tn.jpg') }}" alt="Art in Unexpected Places">
              <div class="textinfo">
                <h5>Still Life</h5>
    ...
    <section id="tuesday" class="schedule">
      <div class="dayinfo">
        ...
        <div class="events">
          <ul>
            <li> <img src="{{ asset('imagenes/Jennifer_Jerome_tn.jpg') }}" alt="Art in Unexpected Places">
              <div class="textinfo">
            ...
            <li> <img src="{{ asset('imagenes/Jonathan_Ferrar_tn.jpg') }}" alt="Art in Unexpected Places">
              <div class="textinfo">
            ...
            <li> <img src="{{ asset('imagenes/Hillary_Goldwynn_tn.jpg') }}" alt="Art in Unexpected Places">
              <div class="textinfo">
  ...
  <aside id="sidebar">
    <article id="artistlist">
      ...
      <div class="pixgrid">
        <ul>
          @include('includes.fotos_artistas')
        </ul>
        <p><a class="link" href="{{ route('artists') }}">View Artist Info</a></p>
      </div>
    </article>
    <!-- Featured Artists -->
